    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
            ...
            <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
                <li class="nav-item">
                    {{-- /code-operation/liste-correspondance/liste-correspondance --}}
                    <a href="{{ url('/code-operation/nouvelle-correspondance') }}"   class="mb-2 me-2 btn-icon btn btn-secondary" >
            ...
            <div class="main-card mb-3 card">
                <div class="card-body">
                    ...
                    <table class="mb-0 table table-striped">
                        ...
                        <tbody>
                            @foreach ($correspondances as $listeNature)
                                <tr>
                                    <th scope="row">
