...
<html>
<head>
    <title>Gestion Mentall |Mot de passe oublié</title>
</head>
<body>
    <style>
            ...
            <table>
                ...
                <tr>
                    <td class="content">
                        ...
                        <p>Votre mot de passe a été initialisé avec succès. <br>
                        Code Utilisateur: {{$email}} <br>
                        Mot de passe par defaut: {{$motdepass}}.</p>

                        <p>Vous devez changer ce mot de passe lors de votre connexion. </p>
